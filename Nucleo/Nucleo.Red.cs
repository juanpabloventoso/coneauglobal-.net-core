...
#pragma warning restore 1591
    ...
    public static class Funciones
    {
        ...
        //
        public static NetworkConnection ConectarRed(string ruta, string usuario, string password)
        {
            return new NetworkConnection(ruta, new System.Net.NetworkCredential(usuario, password));
        }

        //
        // Conectar al dominio ADCONEAU usando el usuario y password registrados
        //
        public static NetworkConnection ConectarDominioCONEAU(string ruta)
        {
            return ConectarRed(ruta, DominioCONEAU_Usuario, DominioCONEAU_Password);
        }
